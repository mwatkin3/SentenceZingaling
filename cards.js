...
function black() {
  return [
    ...
    "No one is so brave that they are not disturbed by ________.",
    ...
    "I met my husband/wife at ________.",
    ...
    "I got ________ in low places.",
    "Where have all the ________ gone?",
    "Mary had a little ________.",
    "Deck the halls with ________",
    "Humpty Dumpty sat on a ________.",
    "Jack and Jill went up the hill to fetch ________.",
    "What are little boys made of?",
    "Yankee Doodle came to town, riding on a _______."
  ];
}
